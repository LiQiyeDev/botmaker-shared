...
public final class GitHubConfig {
    ...
    /** Raw (CDN) URL of the legacy index: Vetted bots only, in the array shape older Studios read. */
    public static String indexRawUrl() {
        return galleryRawUrl(INDEX_PATH);
    }

    /** Raw (CDN) URL of the tiered catalog — no API rate limit, no auth. */
    public static String catalogRawUrl() {
        return galleryRawUrl(CATALOG_PATH);
    }

    private static String galleryRawUrl(String path) {
        return "https://raw.githubusercontent.com/"
                + INDEX_OWNER + "/" + INDEX_REPO + "/" + INDEX_BRANCH + "/" + path;
    }
